...
UI が重要なサービスの場合、ワイヤーフレームを HTML プロトタイプとして作って Notion に添付できる。
...
これらは後で CLAUDE.md やワイヤーフレームページに残す。
...
### Step 6: Notion ページに記録

「27. ワイヤーフレーム」のようなページを作り、以下を記録:

- zip ファイルへの添付（ユーザーが手動でアップロード）
- 画面一覧（採用状況の表）
- 主要な設計判断
- モバイル / PC の対応関係
- 未着手の画面
